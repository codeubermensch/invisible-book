...
cv2.createTrackbar("upper_hue","bars",23,180,hello)
cv2.createTrackbar("upper_saturation","bars",200, 255, hello)
cv2.createTrackbar("upper_value","bars",160, 255, hello)
cv2.createTrackbar("lower_hue","bars",13,180, hello)
cv2.createTrackbar("lower_saturation","bars",140, 255, hello)
cv2.createTrackbar("lower_value","bars",95, 255, hello)
